...
const Contacts = ({ className, block }) => (
  <div className={classnames(styles.contacts, 'text-center', className)}>
    <a href='mailto:chgu82837@gmail.com' target='_blank'>
    ...
    <a href='https://pastleo.me/' target='_blank'>
    ...
    <a href='https://www.linkedin.com/in/guan-yu-chiu-076833120/' target='_blank'>
      <Button className={classnames(styles.contactBtn, { [styles.block]: block })}>
    ...
    <a href='https://fb.me/pastleo' target='_blank'>
      <Button className={classnames(styles.contactBtn, { [styles.block]: block })}>
